...
import com.fanwu.chat.injector.component.DaggerFragmentComponent;
import com.fanwu.chat.injector.component.FragmentComponent;
...
public abstract class BaseFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        mFragmentComponent = DaggerFragmentComponent.builder()
                ...
                .applicationComponent(((ToDoApplication) getActivity().getApplication()).getApplicationComponent())
                .build();
        initInjector();
